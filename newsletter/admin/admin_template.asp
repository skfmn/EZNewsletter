...
<%
	...
	If Trim(Request.Form("save")) <> "" Then
		...
		intTemplateID = DBEncode(Trim(Request.Form("tempid")))
		...
		If NOT rsCommon.EOF Then
			...
			rsCommon.Update
			Response.Cookies("msg") = "tus"
		Else
		    strSQL = "INSERT INTO "&msdbprefix&"newsletter ([news_title],[news_description],[news_body]) Values('"&strTempTitle&",'"&strTempDescription&"'','"&strTempBody&"')"
...
<div id="main" class="container">
    <header>
        <h2 style="text-align:center;">Manage Templates</h2>
    </header>
    <div class="row">
    ...
    <form action="admin_template.asp" id="template" method="post">
            ...
            <div class="-1u 10u 12u(medium)">
                ...
                <div class="row" style="padding-top: 10px;">
                    <div class="6u 12u$(small)">
                        <input class="button fit" type="submit" name="save" value="Save" />
                    </div>
                    <div class="6u$ 12u$(small)">
                        <input class="button fit" type="submit" name="delete" value="Delete" onclick="return confirm('WARNING!\n Are you SURE you want to delete this template?')" />
                    </div>
                </div>
